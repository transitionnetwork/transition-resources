 ...
 * @since 1.0.0
 */
class Transition_Resources_Admin_Batch {
	 ...
	 *
	 * @since 1.0.0
	 * @var Transition_Resources_Admin_Stepper
	 */
	public $stepper;
	...
	public function __construct( $identifier ) {
		...
		$this->stepper = new Transition_Resources_Admin_Stepper( $identifier );
	...
	public function delete() {
		...
		if ( ! isset( $this->stepper ) ) {
			$this->stepper = new Transition_Resources_Admin_Stepper( $this->identifier );
		}
		$this->stepper->delete();
		unset( $this->stepper );
